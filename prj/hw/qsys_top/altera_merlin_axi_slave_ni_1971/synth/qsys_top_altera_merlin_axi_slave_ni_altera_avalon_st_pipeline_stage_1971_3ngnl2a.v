// qsys_top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_3ngnl2a.v

// Generated using ACDS version 23.4 66

`timescale 1 ps / 1 ps
module qsys_top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_3ngnl2a #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 38,
		...
		input  wire [37:0] in_data,   //          .data
		input  wire        out_ready, //   source0.ready
		output wire        out_valid, //          .valid
		output wire [37:0] out_data   //          .data
	);
	...
	qsys_top_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),   //   input,  width = 38,          .data
		.out_ready         (out_ready), //   input,   width = 1,   source0.ready
		.out_valid         (out_valid), //  output,   width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 38,          .data
