...
TOP_LEVEL_NAME="qsys_top_s10_user_rst_clkgate_0.qsys_top_s10_user_rst_clkgate_0"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/nfs/site/disks/swbld_releases_6/acds/23.4/66/linux64/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96.sv"          -work tennm_agilex7_io96_ver
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96_ncrypt.sv"   -work tennm_agilex7_io96_ver
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [qsys_top_s10_user_rst_clkgate_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [qsys_top_s10_user_rst_clkgate_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
