...
# ACDS 23.4 66 linux 2023.11.06.09:05:32
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     qsys_top_intel_niosv_m_0
# 
...
# ----------------------------------------
# If qsys_top_intel_niosv_m_0 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "qsys_top_intel_niosv_m_0.qsys_top_intel_niosv_m_0"
}
...
append ELAB_OPTIONS [subst [qsys_top_intel_niosv_m_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [qsys_top_intel_niosv_m_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [qsys_top_intel_niosv_m_0::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [qsys_top_intel_niosv_m_0::normalize_path "$file"]
  set normalized_dest [qsys_top_intel_niosv_m_0::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [qsys_top_intel_niosv_m_0::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [qsys_top_intel_niosv_m_0::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [qsys_top_intel_niosv_m_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [qsys_top_intel_niosv_m_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
