...
# ACDS 23.4 66 linux 2023.11.06.09:05:14
# ----------------------------------------
...
# ----------------------------------------
# If qsys_top_clock_in is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "qsys_top_clock_in.qsys_top_clock_in"
}
...
append ELAB_OPTIONS [subst [qsys_top_clock_in::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [qsys_top_clock_in::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [qsys_top_clock_in::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [qsys_top_clock_in::normalize_path "$file"]
  set normalized_dest [qsys_top_clock_in::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [qsys_top_clock_in::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [qsys_top_clock_in::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [qsys_top_clock_in::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [qsys_top_clock_in::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
